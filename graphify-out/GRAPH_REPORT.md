...
2. `OverlayController` - 34 edges
3. `isDestroyed()` - 22 edges
4. `bootstrap()` - 21 edges
5. `log()` - 15 edges
6. `HotkeyManager` - 14 edges
7. `ProviderRegistry` - 13 edges
8. `cleanupText()` - 12 edges
9. `RecorderWindowController` - 11 edges
10. `ensureTargetReady()` - 10 edges
...
- `requestMicrophone()` --calls--> `warn()`  [INFERRED]
  /Users/onkarj012/Projects/Alternatives/Trail/Vaani_main/src/renderer/components/OnboardingModal.tsx → /Users/onkarj012/Projects/Alternatives/Trail/Vaani_main/src/main/log.ts
- `registerIpcHandlers()` --calls--> `bootstrap()`  [INFERRED]
  /Users/onkarj012/Projects/Alternatives/Trail/Vaani_main/src/main/ipc.ts → /Users/onkarj012/Projects/Alternatives/Trail/Vaani_main/src/main/index.ts
...
Cohesion: 0.09
Nodes (12): AppDetector, bundleIdToContext(), clippedCopy(), DictationService, isExternalTarget(), isSnippetLikeContent(), messageForInjectionFailure(), safeFocusedValue() (+4 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (10): buildSnippetTrigger(), formatTranscript(), getProviderRegistry(), preserveDockIfDashboardOpen(), computeAppUsageData(), computeHourlyData(), ProviderRegistry, SettingsStore (+2 more)

### Community 3 - "Community 3"
Cohesion: 0.14
Nodes (24): ClipboardTextInjector, confirmInsertion(), delay(), ensureTargetReady(), maybeRestoreCaretAfterInsertion(), modifierReleaseLines(), moveCaretToEndForBrowserTarget(), prefersSystemEventsPaste() (+16 more)
...
- **Are the 15 inferred relationships involving `bootstrap()` (e.g. with `.init()` and `.get()`) actually correct?**
  _`bootstrap()` has 15 INFERRED edges - model-reasoned connections that need verification._
