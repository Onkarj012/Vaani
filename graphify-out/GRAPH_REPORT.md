...
## Corpus Check
- 115 files · ~577,104 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 478 nodes · 763 edges · 94 communities detected
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 147 edges (avg confidence: 0.8)
...
Cohesion: 0.06
Nodes (30): armMainWindowReadyTimeout(), bootstrap(), cleanupRuntimeResources(), clearMainWindowReadyTimeout(), configureMediaPermissions(), configureRendererLifecycle(), createMainWindow(), isDictationActive() (+22 more)
...
- **Thin community `Community 27`** (2 nodes): `App.tsx`, `main.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (2 nodes): `LandingPage()`, `LandingPage.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (2 nodes): `PageTransition()`, `PageTransition.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (2 nodes): `DevanagariIcon()`, `AppLayout.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (2 nodes): `AnimatedNumber()`, `Stats.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (2 nodes): `SettingCard()`, `SettingsPage.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (2 nodes): `createSettings()`, `cleanup.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (2 nodes): `createDictationService()`, `dictation.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (2 nodes): `walk()`, `generate-latest-mac-yml.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `log()` connect `Community 0` to `Community 1`, `Community 2`, `Community 6`, `Community 8`, `Community 10`, `Community 14`?**
  _High betweenness centrality (0.166) - this node is a cross-community bridge._
- **Why does `bootstrap()` connect `Community 0` to `Community 4`, `Community 12`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `maybeRestoreCaretAfterInsertion()` connect `Community 2` to `Community 0`, `Community 10`?**
